...
class WebviewProvider {
    showResults(output, componentName, context) {
        if (this.panel) {
            this.panel.reveal(vscode.ViewColumn.Two);
        }
        else {
            this.panel = vscode.window.createWebviewPanel('uiInsightResults', `UI Insight: ${componentName}`, vscode.ViewColumn.Two, {
                enableScripts: true,
    ...
    getHtmlContent(output, componentName) {
